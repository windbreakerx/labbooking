    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("role", models.CharField(choices=[("STUDENT", "Студент"), ("TEACHER", "Преподаватель"), ("LAB_ADMIN", "Сотрудник лаборатории"), ("SYS_ADMIN", "Системный администратор")], default="STUDENT", max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("student_id", models.CharField(blank=True, max_length=64, verbose_name="ID студента")),
                ...
                ("no_show_count", models.PositiveIntegerField(default=0, verbose_name="Количество неявок")),
