...
env = environ.Env(
    ...
    MANUAL_BOOKING_WORKING_WEEKS=(int, 2),
)
...
MANUAL_BOOKING_WORKING_WEEKS = env("MANUAL_BOOKING_WORKING_WEEKS")
BOOKING_DAY_CLOSES_AT = env("BOOKING_DAY_CLOSES_AT", default="15:00")
